...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"n", false,-1, 15,0);
    tracep->declBus(c+5,"dout", false,-1, 7,0);
    tracep->declBit(c+6,"clktickout", false,-1);
    tracep->pushNamePrefix("clktickIn ");
    ...
    tracep->pushNamePrefix("finiteMachine ");
    tracep->declBit(c+2,"clk", false,-1);
    tracep->declBit(c+1,"rst", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,(vlSelf->top__DOT__clktickout));
    bufp->fullSData(oldp+7,(vlSelf->top__DOT__clktickIn__DOT__count),16);
    bufp->fullIData(oldp+8,(vlSelf->top__DOT__finiteMachine__DOT__current_state),32);
    bufp->fullIData(oldp+9,(vlSelf->top__DOT__finiteMachine__DOT__next_state),32);
